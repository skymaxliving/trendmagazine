              ...
              <div className="relative aspect-[16/9]">
                ...
                <div className="absolute bottom-0 left-0 right-0 px-5 pb-8 pt-4">
                  ...
                  <div className="flex items-center gap-3 text-white/60 text-[11px]">
                    ...
                    <span className="flex items-center gap-1"><Calendar className="w-3 h-3" /> {formatDateTime(art.date)}</span>
            ...
            <Link href={`/clanek/${article.slug}`} className="no-underline group block absolute inset-0">
              <div className="absolute bottom-0 left-0 right-0 p-8 pb-10 lg:p-14 lg:pb-14">
                ...
                <div className="flex items-center gap-4 text-white/60 text-xs">
                  ...
                  <span className="flex items-center gap-1"><Calendar className="w-3 h-3" /> {formatDateTime(article.date)}</span>
                  <span className="flex items-center gap-1">
